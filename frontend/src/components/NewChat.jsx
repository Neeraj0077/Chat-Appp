...
//   return (
//     <div className={`absolute top-0 left-0 h-full w-20 lg:w-72 z-50 bg-[#1a1d27] flex flex-col border-r border-base-300 ${isClosing ? "animate-slide-out" : "animate-slide-in"}`}>


// <div className="p-5 bg-[#1e2130]">
...
//               <div className="font-medium truncate text-gray-200">{user.fullname}</div>
...
//         {filtered.length === 0 && (
//           <div className="text-center text-zinc-500 py-4 text-sm">No contacts found</div>
//         )}
//       </div>
//     </div>
//   );
