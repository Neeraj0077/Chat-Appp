          ...
          return (
            ...
            >
              ...
              <div className="hidden lg:flex flex-1 flex-col text-left min-w-0">
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  <div className="flex items-center gap-1 min-w-0">
                    {/* Show "typing..." or last message preview */}
                    {isUserTyping ? (
                      <span className="text-xs text-[#5754E8] font-medium flex items-center gap-1">
                        typing
                        <span className="flex gap-0.5 items-center">
                          <span className="size-1 bg-[#5754E8] rounded-full animate-bounce [animation-delay:0ms]" />
                          <span className="size-1 bg-[#5754E8] rounded-full animate-bounce [animation-delay:150ms]" />
                          <span className="size-1 bg-[#5754E8] rounded-full animate-bounce [animation-delay:300ms]" />
                        </span>
                      </span>
                    ) : (
                      <>
